import { DECIMAL_LIST, ROMAN_NUMERAL_LIST, ROMAN_NUMERAL_SYMBOL, ROMAN_NUMERAL_SYMBOL_KIND, isRomanNumeralSymbol, lookup } from './Symbols.js';
    ...
    */
    constructor(romanNumeral) {
        ...
        for (const currentSymbol of reversed) {
            ...
            const nextGroup = currentSymbol + group;
